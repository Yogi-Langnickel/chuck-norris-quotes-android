...
2. Download the `chuck-norris-quotes-android-1.3.5-debug.apk` asset.
...
```bash
adb install -r chuck-norris-quotes-android-1.3.5-debug.apk
```
...
- Version: `1.3.5`
- APK SHA-256: `5f58333ecfe769c6be2581a78b4a8e8065ed8d348632bfc320c66a59e64383b3`
